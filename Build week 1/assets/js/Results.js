...
// prendo dall'url il vaore result
...
document.getElementById("outcome-positive").innerHTML = percentualeSuccesso + "%";

let percentualeFallimento = 100 - percentualeSuccesso;
document.getElementById("outcome-negative").innerHTML = percentualeFallimento + "%";
